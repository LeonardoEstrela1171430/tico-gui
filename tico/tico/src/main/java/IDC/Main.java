...
//         runComparator(onto_path, instance_path, print_path, 0);
    ...
    public static void getEvolActions(String ontology, String instance)
    {
        OntModel ontModel = ModelFactory.createOntologyModel(OntModelSpec.OWL_DL_MEM);
        ontModel.read(ontology, null);
        OntModel instanceModel = ModelFactory.createOntologyModel(OntModelSpec.OWL_DL_MEM);
        ontModel.read(instance, null);
