...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function (){
	  ...
	  app.initialize = function (ontologyContent, iri, version){
		globalOntologyContent = ontologyContent;
		globalIRI = iri;
	  ...
	  function loadOntologyFromTextCustom( jsonText, filename ){
		debugger;
	    d3.select("#reloadCachedOntology").classed("hidden", true);
	    pauseMenu.reset();
	    graph.options().navigationMenu().hideAllMenus();
	    ...
	    if ( classCount === 0 && graph.editorMode() === false && loadEmptyOntologyForEditing === false ) {
	      ...
	      loadingModule.validJsonFileCustom();
		  debugger;
	      ontologyMenu.setCachedOntology(filename, jsonText);
	      exportMenu.setJsonText(jsonText);
	      options.data(data);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function ( graph ){
	  ...
	  ontologyMenu.setupCustom = function (  ){
		debugger;
	    loadingModule = graph.options().loadingModule();
	    var menuEntry = d3.select("#m_select");
	    menuEntry.on("mouseover", function (){
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function ( graph ){
	  ...
	  sidebar.updateGeneralOntologyInfo = function (){
		...
		if(globalIRI){
			generalMetaObj.title = globalIRI;
		}

		if(globalVersion){
			generalMetaObj.version = globalVersion;
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	//2] File Upload to OWL2VOWL Converter
	  ...
	  loadingModule.validJsonFileCustom = function (){
	    ontologyMenu.append_message_toLastBulletPoint("done");
	    loadingWasSuccessFul = true;
	  };
