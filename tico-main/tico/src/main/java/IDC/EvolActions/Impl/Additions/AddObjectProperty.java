...
public class AddObjectProperty extends AddProperty
{
   boolean inverseFunctional   = false;
    ...
    public String className = "AddObjectProperty";
    ...
    public List<OntProperty> getInverseOf() {
        return inverseOf;
    }

    public void setInverseOf(List<OntProperty> inverseOf) {
        this.inverseOf = inverseOf;
    }

    private List<OntProperty> inverseOf = new ArrayList<>();
