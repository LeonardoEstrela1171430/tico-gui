        ...
        module.exports = function () {
          ...
          var app = {},
            ...
            compactNotationSwitch =
              webvowl.modules.compactNotationSwitch(graph),
            ...
            selectionDetailDisplayer =
              webvowl.modules.selectionDetailsDisplayer(
          ...
          function adjustSize() {
            ...
            if (warningDiv.classed("hidden") === false) {
              var offset =
                10 + warningDiv.node().getBoundingClientRect().height;
      ...
      /* WEBPACK VAR INJECTION */ (function (d3) {
        ...
        module.exports = function (graph) {
          ...
          function inlineVowlStyles() {
            ...
            setStyleSensitively(".cardinality", [
            ...
            setStyleSensitively("path, .nofill", [
            ...
            setStyleSensitively(".values-from", [
          ...
          exportMenu.createJSON_exportObject = function () {
            ...
            if (
              metaObj.description &&
              metaObj.description !== header.description
            ) {
      ...
      module.exports = function (graph) {
        ...
        function preparePrefixRepresentation() {
          ...
          for (i = 0; i < allNodes.length; i++) {
            var nodeIRI = prefixModule.getPrefixRepresentationForFullURI(
              allNodes[i].iri()
            );
          ...
          for (i = 0; i < allProps.length; i++) {
            var propIRI = prefixModule.getPrefixRepresentationForFullURI(
              allProps[i].iri()
            );
        ...
        function extractClassDescription(node) {
          ...
          for (var e = 0; e < node.equivalents().length; e++) {
            var eqIRI = prefixModule.getPrefixRepresentationForFullURI(
          ...
          if (arrayOfNodes.length > 0) {
            ...
            for (var duE = 0; duE < arrayOfNodes.length; duE++) {
              var duIri = prefixModule.getPrefixRepresentationForFullURI(
          ...
          if (arrayOfUnionNodes.length > 0) {
            // add disjoint unionOf
            objectDef +=
              indent + " rdfs:subClassOf [ rdf:type owl:Class ; \r\n";
            ...
            for (var uE = 0; uE < arrayOfUnionNodes.length; uE++) {
              if (arrayOfUnionNodes[uE] && arrayOfUnionNodes[uE].iri()) {
                var uIri = prefixModule.getPrefixRepresentationForFullURI(
        ...
        function getOntologyDescription(indent) {
          return general_languageExtractor(
            indent,
            "description",
            "dc:description"
          );
      ...
      /* WEBPACK VAR INJECTION */ (function (d3) {
        ...
        module.exports = function (graph) {
          ...
          filterMenu.highlightForDegreeSlider = function (enable) {
            ...
            if (
              menuControl.classed("buttonPulse") === true &&
              enable === true
            ) {
              menuControl.classed("buttonPulse", false);
      ...
      /* WEBPACK VAR INJECTION */ (function (d3) {
        ...
        module.exports = function (graph) {
          ...
          modeMenu.setup = function (
            ...
            colorModeSwitch = addExternalModeSelection(
              container,
              colorExternals
            );
          };
      ...
      /* WEBPACK VAR INJECTION */ (function (d3) {
        ...
        module.exports = function (graph) {
          ...
          function callbackFromDirectInput_Success(parameter) {
            ...
            loadingModule.loadFromOWL2VOWL(
              parameter[0],
              "DirectInputConversionID" + local_conversionId
            );
            ontologyMenu.conversionFinished();
          }
          ...
          function callbackFromDirectInput_ERROR(parameter) {
            ...
            if (local_conversionId !== conversion_sessionId) {
              console.log(
                "The loading process for direct input has been canceled!"
              );
              return;
            }
            ...
            if (error !== null && error.status === 500) {
              append_message(
                "<span style='color:red'>Could not convert direct input</span>"
              );
            }
            if (request && request.responseText.length === 0) {
              append_message(
          ...
          function callbackLoadFromOntology(
            selectedFile,
            filename,
            local_threadId
          ) {
          ...
          function displayLoadingIndicators() {
            d3.select("#layoutLoadingProgressBarContainer").classed(
              "hidden",
              false
            );
        ...
        module.exports = function (graph) {
          ...
          function updateMenuPosition() {
            if (currentlyHoveredEntry) {
              ...
              var fullContainer_width =
                scrollContainer.getBoundingClientRect().width;
              var elementWidth = currentlyVisibleMenu
                .node()
                .getBoundingClientRect().width;
      ...
      /* WEBPACK VAR INJECTION */ (function (d3) {
        ...
        module.exports = function (graph) {
          ...
          function updateGraphInformation() {
            var title = languageTools.textInLanguage(
              ontologyInfo.title,
              graph.language()
            );
            ...
            var description = languageTools.textInLanguage(
          ...
          function setSelectionInformationVisibility(
            ...
            d3.select("#classSelectionInformation").classed(
              "hidden",
              !showClasses
            );
          ...
          function displayNodeInformation(node) {
            ...
            var disjointNodesParent = d3.select(
              disjointNodes.node().parentNode
            );
            ...
            sideBarContainer
              ...
              .addEventListener("animationend", function () {
                ...
                if (visibleSidebar === true) {
                  ...
                  d3.select("#leftSideBarCollapseButton").style(
                    "left",
                    "200px"
                  );
                  d3.select("#leftSideBarCollapseButton").classed(
                    "hidden",
                    false
                  );
      ...
      /* WEBPACK VAR INJECTION */ (function (d3) {
        ...
        module.exports = function (graph) {
          ...
          function setupSupportedDatatypes() {
            var datatypeEditorSelection = d3
            ...
            for (var name in prefixElements) {
              if (prefixElements.hasOwnProperty(name)) {
                ...
                deleteButton.selectAll("g").on("mouseover", function () {
                  var selector = this;
                  var enable = true;
                  var f_deletePath = d3.select(
                    "#del_pathFor_" + selector.selectorName
                  );
                  var f_deleteRect = d3.select(
          ...
          function enablePrefixEdit(item) {
            ...
            if (stl === "save") {
              ...
              if (
                ...
                d3
                  .select("#prefixInputFor_" + newPrefix)
                  .node().disabled = true;
          ...
          function identifyExternalCharacteristicForElement(
            ontoIRI,
            elementIRI
          ) {
          ...
          editSidebar.updateEditDeleteButtonIds = function (
            oldPrefix,
            newPrefix
          ) {
            ...
            if (element === undefined) {
              ...
              d3.select("#element_iriEditor")
                .on("change", function () {
                  ...
                  if (
                    prefixed === d3.select("#element_iriEditor").node().value
                  ) {
                ...
                .on("change", function () {
                  ...
                  if (element.iri() !== url) {
                    ...
                    if (elementTools.isNode(element) === true) {
                      sanityCheckResult =
                        graph.checkIfIriClassAlreadyExist(url);
                      if (sanityCheckResult !== false) {
                        graph
                          .options()
                          .warningModule()
          ...
          editSidebar.updateElementWidth = function () {
            ...
            d3.select("#containerForLeftSideBar").style(
              "top",
              lsb_offset + "px"
            );
            d3.select("#leftSideBarCollapseButton").style(
          ...
          function addElementsCharacteristics(element) {
            ...
            var i;
            // KILL old elements
            var charSelectionNode = d3.select(
      ...
      /* WEBPACK VAR INJECTION */ (function (d3) {
        module.exports = function (graph) {
          ...
          loadingModule.emptyGraphContentError = function () {
            console.log("emptyGraphContentError");
            graph.clearGraphData();
          ...
          loadingModule.parseUrlAndLoadOntology = function (storeCache) {
            ...
            var loadingMethod = identifyOntologyLoadingMethod(urlString);
            ...
            switch (loadingMethod) {
              ...
              case 3:
                ...
                break;
              case 4:
                loadingModule.from_REST_Call(ontologyIdentifierFromURL);
                break;
              default:
                console.log(
          ...
          loadingModule.from_JSON_URL = function (fileName) {
            ...
            if (ontologyMenu.cachedOntology(filename)) {
              ...
              requestServerTimeStampForJSON_URL(
                ontologyMenu.callbackLoad_JSON_FromURL,
            ...
            d3.xhr(
              ...
              function (error, request) {
                if (error) {
                  ...
                  ontologyMenu.setConversionID(conversion_sessionId);
                  callback(text, [
                    "conversionID" + conversion_sessionId,
                    conversion_sessionId,
                  ]);
                }
              }
          ...
          loadingModule.from_IRI_URL = function (fileName) {
            ...
            if (ontologyMenu.cachedOntology(filename)) {
              ...
              requestServerTimeStampForIRI_Converte(
          ...
          loadingModule.from_REST_Call = function (id) {
            d3.select("#progressBarValue").node().innerHTML = " ";
            loadingModule.initializeLoader(false);

            ontologyMenu.append_bulletPoint(
              "Retrieving ontology from requested file: " + id
            );
            var ontologyContent = "";
          ...
          loadingModule.fromFileDrop = function (fileName, file) {
            ...
            if (fileName.match(/\.json$/)) {
              ...
              requestServerTimeStamp(
                ontologyMenu.callbackLoadFromOntology,
                parameterArray
              );
            }
          };
            ...
            d3.xhr(
              ...
              function (error, request) {
                ...
                if (error) {
                  ...
                  parameterArray[0] =
                    parameterArray[0] + "&sessionId=" + conversion_sessionId;
          ...
          function loadPresetOntology(ontology) {
            console.log("loadPresetOntology");
          ...
          function loadGraphOptions(parameterArray) {
            ...
            function loadDefaultConfig() {
              graph
                .options()
                .setOptionsFromURL(graph.options().defaultConfig(), false);
            }
            ...
            function identifyOptions(paramArray) {
              if (paramArray[0].indexOf(optString) >= 0) {
                ...
                var givenOptionsStr = paramArray[0].substr(
                  5,
                  parameterLength - 6
                );
      ...
      /* WEBPACK VAR INJECTION */ (function (d3) {
        module.exports = function (graph) {
          ...
          warningModule.addMessageBox = function () {
            // add a container;
            _messageId++;
            var messageContainer = d3
              .select("#WarningErrorMessages")
              .append("div");
          ...
          warningModule.createMessageContext = function (id) {
            ...
            moduleContainer.style(
              "-webkit-animation-name",
              "warn_ExpandAnimation"
            );
          ...
          warningModule.closeMessage = function (id) {
            ...
            moduleContainer.style(
              "-webkit-animation-name",
              "warn_CollapseAnimation"
            );
            moduleContainer.style("-webkit-animation-duration", "0.5s");

            var m_height = moduleContainer
              .node()
              .getBoundingClientRect().height;
            ...
            for (var fc = 0; fc < followingChildren.length; fc++) {
              ...
              var superCss =
                document.styleSheets[styleSelectorIndex].cssRules[
                  cssStyleIndex
                ];
              ...
              child
                .node()
                .addEventListener("animationend", _child_animationEnd);
            }
          };
