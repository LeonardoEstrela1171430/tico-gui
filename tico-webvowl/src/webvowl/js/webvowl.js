  ...
  /******/ [
      ...
      module.exports = (function () {
        var o = function (graph) {
          ...
          function createTextBlock() {
            ...
            var textBlock = new CenteringTextElement(
              that.nodeElement(),
              bgColor
            );
          ...
          var Base = function (graph) {
            ...
            this.removePropertyElement = function (property) {
              ...
              if (assignedProperties.indexOf(property) !== -1) {
                ...
                assignedProperties.splice(
                  assignedProperties.indexOf(property),
                  1
                );
              }
            };
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      module.exports = (function () {
        ...
        languageTools.textInLanguage = function (
          textObject,
          preferredLanguage
        ) {
          ...
          if (
            preferredLanguage &&
            textObject.hasOwnProperty(preferredLanguage)
          ) {
          ...
          textForLanguage = searchLanguage(
            textObject,
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      CenteringTextElement.prototype = Object.create(
        AbstractTextElement.prototype
      );
      ...
      CenteringTextElement.prototype.addInstanceCount = function (
        instanceCount
      ) {
        if (instanceCount) {
          this.addTextline(
    ...
    /***/ function (module, exports, __webpack_require__) {
      /* WEBPACK VAR INJECTION */ (function (d3) {
        ...
        AbstractTextElement.prototype._getTextColor = function (
          rawBackgroundColor
        ) {
      ...
      module.exports = (function () {
        var o = function (graph) {
          ...
          this.postDrawActions = function () {
            ...
            var textElement = new AbsoluteTextElement(
              that.nodeElement(),
              that.backgroundColor()
            );
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      AbsoluteTextElement.prototype = Object.create(
        AbstractTextElement.prototype
      );
      ...
      AbsoluteTextElement.prototype._repositionTextLine = function (
        tspan,
        yShift
      ) {
        var fontSizeProperty = window
    ...
    /***/ function (module, exports) {
      ...
      function Label(property, link) {
        ...
        Object.defineProperty(this, "fixed", {
          get: function () {
            var inverseFixed = property.inverse()
        ...
        module.exports = (function () {
          var o = function (graph) {
            ...
            this.getMyWidth = function () {
              ...
              var indicatorWidth =
                measureTextWidth(indicatorText, "subtext") + 20;
        ...
        module.exports = (function () {
          ...
          var Base = function (graph) {
            ...
            this.draw = function (labelGroup) {
              ...
              if (that.inverse()) {
                var yTransformation =
                  that.height() / 2 + 1; /* additional space */
            ...
            this.drawPin = function () {
              ...
              if (that.inverse()) {
                ...
                var thatY = /translate\(\s*([^\s,)]+)[ ,]([^\s,)]+)/.exec(
                  tr_that
                )[2];
                var invY = /translate\(\s*([^\s,)]+)[ ,]([^\s,)]+)/.exec(
                  tr_inv
                )[2];
    ...
    /***/ function (module, exports, __webpack_require__) {
      /* WEBPACK VAR INJECTION */ (function (d3) {
        ...
        module.exports = (function () {
           ...
           * @returns {{x: number, y: number}}
           */
          math.calculateIntersection = function (
            source,
            target,
            additionalDistance
          ) {
            ...
            var ratio =
                (length - (innerDistance + additionalDistance)) / length,
              x = dx * ratio + source.x,
              y = dy * ratio + source.y;
      ...
      module.exports = (function () {
        var o = function (graph) {
          ...
          this.drawLabel = function (labelContainer) {
            ...
            var textElement = new CenteringTextElement(
              labelContainer,
              this.backgroundColor()
            );
            if (!graph.options().compactNotation()) {
      ...
      /* WEBPACK VAR INJECTION */ (function (d3) {
        ...
        module.exports = function (graphContainerSelector) {
            ...
            dragBehaviour = d3.behavior
              ...
              .on("dragstart", function (d) {
                ...
                if (d.type && d.type() === "Class_dragger") {
                  ...
                  graph.ignoreOtherHoverEvents(true);
                  clearTimeout(delayedHider);
                  frozenDomainForPropertyDragger = shadowClone
                    .parentNode()
                    .domain();
                  frozenRangeForPropertyDragger = shadowClone
                    .parentNode()
                    .range();
              ...
              .on("drag", function (d) {
                if (d.type && d.type() === "Class_dragger") {
                  ...
                  domainDragger.updateElementViaRangeDragger(
                    d3.event.x,
                    d3.event.y
                  );
                } else if (d.type && d.type() === "Domain_dragger") {
                  ...
                  rangeDragger.updateElementViaDomainDragger(
                    d3.event.x,
                    d3.event.y
                  );
                } else {
              ...
              .on("dragend", function (d) {
                ...
                if (d.type && d.type() === "Class_dragger") {
                  ...
                  var targetDomainNode =
                    graph.getTargetNode(domainDraggerEndPos);
          ...
          function hiddenRecalculatePositions() {
            finishedLoadingSequence = false;
            if (
              graph.options().loadingModule().successfullyLoadedOntology() ===
              false
            ) {
              force.stop();
            ...
            if (updateRenderingDuringSimulation === false) {
              ...
              if (value > 0.49) {
                ...
                if (
                  ...
                  force.nodes().length > 0
                ) {
                  if (force.nodes().length < 10)
                    graph.forceRelocationEvent(true); // uses dynamic zoomer;
                ...
                if (
                  graph.options().loadingModule().missingImportsWarning() ===
                  false
                ) {
            ...
            if (!editMode) {
              ...
              labelGroupElements.attr("transform", function (label) {
                ...
                if (link.layers().length === 1 && !link.loops()) {
                  var linkDomainIntersection = math.calculateIntersection(
                    link.range(),
                    link.domain(),
                    0
                  );
                  var linkRangeIntersection = math.calculateIntersection(
                    link.domain(),
                    link.range(),
                    0
                  );
              ...
              linkPathElements.attr("d", function (l) {
                ...
                var pathStart = math.calculateIntersection(
                  curvePoint,
                  l.domain(),
                  1
                );
                var pathEnd = math.calculateIntersection(
                  curvePoint,
                  l.range(),
                  1
                );
          ...
          graph.clearAllGraphData = function () {
            if (
              ...
              graph.graphNodeElements().length > 0
            ) {
              cachedJsonOBJ = graph
                .options()
                .exportMenu()
          ...
          function loadGraphData(init) {
            ...
            if (options.data() !== undefined) {
              ...
              if (header) {
                if (header.iri) {
                  graph
                    .options()
                    .addOrUpdateGeneralObjectEntry("iri", header.iri);
                }
                if (header.title) {
                  graph
                    .options()
                    .addOrUpdateGeneralObjectEntry("title", header.title);
                }
                if (header.author) {
                  graph
                    .options()
            ...
            options.filterModules().forEach(function (module) {
              initializationData = filterFunction(
                module,
                initializationData,
                true
              );
          ...
          function storeLinksOnNodes(nodes, links) {
            for (var i = 0, nodesLength = nodes.length; i < nodesLength; i++) {
              ...
              for (
                var j = 0, linksLength = links.length;
                j < linksLength;
                j++
              ) {
                var link = links[j];
          ...
          function setPositionOfOldLabelsOnNewLabels(
            oldLabelNodes,
            labelNodes
          ) {
          ...
          graph.updatePulseIds = function (nodeIdArray) {
            ...
            if (pulseNodeIds.length > 0) {
              ...
              d3.select("#locateSearchResult").node().title =
                "Locate search term";
            } else {
              d3.select("#locateSearchResult").classed("highlighted", false);
              d3.select("#locateSearchResult").node().title =
          ...
          graph.getBoundingBoxForTex = function () {
            ...
            var topLeft = getWorldPosFromScreen(
              0,
              0,
              graphTranslation,
              zoomFactor
            );
            var botRight = getWorldPosFromScreen(
              w,
              h,
              graphTranslation,
              zoomFactor
            ...
            var t_topLeft = getWorldPosFromScreen(
              bbox.left,
              bbox.top,
              graphTranslation,
              zoomFactor
            );
            var t_botRight = getWorldPosFromScreen(
              bbox.right,
              bbox.bottom,
              graphTranslation,
              zoomFactor
            ...
            var tt_topLeft = getWorldPosFromScreen(
              contentBBox.tx,
              contentBBox.ty,
              graphTranslation,
              zoomFactor
            );
            var tt_botRight = getWorldPosFromScreen(
              contentBBox.bx,
              contentBBox.by,
              graphTranslation,
              zoomFactor
          ...
          graph.changePropertyType = function (element) {
            ...
            var propPrototype = PropertyPrototypeMap.get(
            ...
            if (aProp.type() === "rdfs:subClassOf") {
              ...
              if (
                ...
                aProp.iri(
                  graph.options().getGeneralMetaObjectProperty("iri") +
                    aProp.id()
                );
            }
          ...
          graph.editorMode = function (val) {
            ...
            // box =ModuleCheckbox
            var compactNotationContainer = d3.select(
            ...
            if (editMode === true) {
              options
                .leftSidebar()
                .showSidebar(
                  options.leftSidebar().getSidebarVisibility(),
                  true
                );
          ...
          graph.propertyCheckExistenceChecker = function (
            property,
            domain,
            range
          ) {
          ...
          function createNewObjectProperty(domain, range, draggerEndposition) {
            ...
            var defaultPropertyName = d3
              .select("#defaultProperty")
              .node().title;

            // check if we are allow to create that property
            if (
              graph.sanityCheckProperty(domain, range, defaultPropertyName) ===
              false
            )
              return false;
            ...
            // check for duplicate;
            if (
              graph.propertyCheckExistenceChecker(aProp, domain, range) ===
              false
            ) {
              // delete aProp;
          ...
          graph.createDataTypeProperty = function (node) {
            ...
            var defaultDatatypeName = d3
              .select("#defaultDatatype")
              .node().title;
          ...
          graph.removeNodesViaResponse = function (
            nodesToRemove,
            propsToRemove
          ) {
            var i, remId;
          ...
          graph.removePropertyViaEditor = function (property) {
            ...
            if (
              property.type().toLocaleLowerCase() === "owl:datatypeproperty"
            ) {
          ...
          graph.executeEmptyLiteralFilter = function () {
            if (unfilteredData && unfilteredData.nodes.length > 1) {
              ...
              unfilteredData.properties = options
                .literalFilter()
                .filteredProperties();
            }
          };
          ...
          graph.modified_dblClickFunction = function () {
            ...
            var grPos = getClickedScreenCoords(
              d3.event.clientX,
              d3.event.clientY,
              graph.translation(),
              graph.scaleFactor()
          ...
          function touchzoomed() {
            ...
            var touch_time = d3.event.timeStamp;
            if (
              touch_time - last_touch_time < 300 &&
          ...
          graph.showHoverElementsAfterAnimation = function (
            property,
            inversed
          ) {
          ...
          graph.activateHoverElementsForProperties = function (
            ...
            if (val === true) {
              ...
              if (hoveredPropertyElement) {
                if (
                  hoveredPropertyElement.domain() ===
                  hoveredPropertyElement.range()
                ) {
                  hoveredPropertyElement.labelObject().increasedLoopAngle = false;
                  recalculatePositions();
                }
          ...
          function setDeleteHoverElementPositionProperty(property, inversed) {
            if (property && property.labelElement()) {
              ...
              var widthElement = parseFloat(
                property.getShapeElement().attr("width")
              );
              var heightElement = parseFloat(
      ...
      /* WEBPACK VAR INJECTION */ (function (d3) {
        module.exports = function () {
          ...
          function updateConfigObject() {
            defaultOptionsConfig.sidebar = options
              .sidebar()
            ...
            defaultOptionsConfig.mode_dynamic = String(
              options.dynamicLabelWidth()
            );
          ...
          options.setOptionsFromURL = function (opts, changeEditFlag) {
            ...
            if (opts.editorMode) {
              ...
              d3.select("#editorModeModuleCheckbox").node().checked =
                settingFlag;
      ...
      /* WEBPACK VAR INJECTION */ (function (d3) {
        ...
        module.exports = function (graph) {
          ...
          parser.parse = function (ontologyData) {
            ...
            var classes = combineClasses(
                ontologyData.class,
                ontologyData.classAttribute
              ),
              datatypes = combineClasses(
            ...
            addSetOperatorProperties(
              combinedClassesAndDatatypes,
              unparsedProperties
            );
            combinedProperties = combineProperties(
              unparsedProperties,
              ...
              baseObjects.forEach(function (element) {
                ...
                if (Prototype) {
                  ...
                  if (element.attributes) {
                    var deduplicatedAttributes = d3.set(
          ...
          function mergeRangesOfEquivalentProperties(properties, nodes) {
            ...
            var newNodes = equivalentPropertyMerger.merge(
              properties.slice(),
              nodes.slice(),
              propertyMap,
              classMap,
           ...
           */
          function createPropertyStructure(
            rawProperties,
            classMap,
            propertyMap
          ) {
	       ...
	       inverse properties with optional inverse and optional domain and range attributes */
            ...
            rawProperties.forEach(function (property) {
              ...
              var equalProperty = getOtherEqualProperty(
                rawProperties,
                property
              );
          ...
          function processEquivalentIds(element, elementMap) {
            ...
            for (var i = 0, l = eqIds.length; i < l; ++i) {
              ...
              if (eqObject) {
                ...
                console.warn(
                  "No class/property was found for equivalent id: " + eqId
                );
              }
            }
          }
    ...
    /***/ function (module, exports, __webpack_require__) {
      /* WEBPACK VAR INJECTION */ (function (d3) {
        ...
        function findMergeNode(propertyWithEquivalents, nodeMap) {
          var typeMap = mapPropertiesRangesToType(
            propertyWithEquivalents,
            nodeMap
          );
        ...
        module.exports = function (graph) {
          ...
          Class_dragger.setParentNode = function (parentNode) {
            ...
            if (Class_dragger.mouseButtonPressed === false) {
              if (
                ...
                Class_dragger.x =
                  Class_dragger.parent.x +
                  10 +
                  Class_dragger.parent.actualRadius();
                Class_dragger.y =
                  Class_dragger.parent.y +
                  10 +
                  Class_dragger.parent.actualRadius();
              } else {
          ...
          Class_dragger.drawNode = function () {
            ...
            Class_dragger.draggerObject =
              Class_dragger.rootNodeLayer.append("circle");
            if (graph.options().useAccuracyHelper()) {
              Class_dragger.draggerObject
                .attr("r", 40)
                .attr("cx", 0)
          ...
          Class_dragger.setAdditionalClassForClass_dragger = function (
            name,
            val
          ) {
    ...
    /***/ function (module, exports, __webpack_require__) {
      /* WEBPACK VAR INJECTION */ (function (d3) {
        module.exports = function (graph) {
          ...
          Range_dragger.setParentProperty = function (
            parentProperty,
            inversed
          ) {
          ...
          Range_dragger.updateElementViaDomainDragger = function (x, y) {
            ...
            var ep_range_x =
              dex + nX * Range_dragger.parent.range().actualRadius();
            var ep_range_y =
              dey + nY * Range_dragger.parent.range().actualRadius();
          ...
          Range_dragger.setAdditionalClassForClass_dragger = function (
            name,
            val
          ) {};
          return Range_dragger;
    ...
    /***/ function (module, exports) {
      module.exports = function (graph) {
        ...
        Domain_dragger.updateElementViaRangeDragger = function (x, y) {
          ...
          var ep_range_x =
            dex + nX * Domain_dragger.parent.domain().actualRadius();
          var ep_range_y =
            dey + nY * Domain_dragger.parent.domain().actualRadius();
        ...
        Domain_dragger.setPosition = function (x, y) {
          ...
          var angle =
            (Math.atan2(range_y - ep_range_y, range_x - ep_range_x) * 180) /
              Math.PI +
            180;
        ...
        Domain_dragger.setAdditionalClassForClass_dragger = function (
          name,
          val
        ) {
          // console.log("Class_dragger should sett the class here")
      ...
      module.exports = function (graph) {
        ...
        ShadowClone.setPositionDomain = function (e_x, e_y) {
          ...
          if (elementTools.isDatatype(ShadowClone.parent.range()) === true) {
            var intersection = math.calculateIntersection(
              { x: e_x, y: e_y },
            ...
            var nY = dir_Y / len;
            ShadowClone.s_x =
              rex - nX * ShadowClone.parent.range().actualRadius();
            ShadowClone.s_y =
              rey - nY * ShadowClone.parent.range().actualRadius();
          }
        ...
        ShadowClone.setPosition = function (s_x, s_y) {
          ...
          ShadowClone.e_x =
            dex + nX * ShadowClone.parent.domain().actualRadius();
          ShadowClone.e_y =
            dey + nY * ShadowClone.parent.domain().actualRadius();
    ...
    /***/ function (module, exports) {
      module.exports = function (graph) {
        ...
        prefixRepresentationModule.getPrefixRepresentationForFullURI =
          function (fullURL) {
      ...
      /* WEBPACK VAR INJECTION */ (function (d3) {
        ...
        module.exports = function () {
          ...
          filter.filter = function (untouchedNodes, untouchedProperties) {
            ...
            var externalElements = filterExternalElements(
              nodes.concat(properties)
            );
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      module.exports = function () {
        ...
        function removeDatatypesAndLiterals() {
          var filteredData = filterTools.filterNodesAndTidy(
            nodes,
            properties,
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      module.exports = (function () {
         ...
         */
        tools.filterNodesAndTidy = function (
          nodes,
          properties,
          shouldKeepNode
        ) {
      ...
      module.exports = function (menu) {
        ...
        function findAutoDefaultDegree(nodes, properties, maxDegree) {
          for (var degree = 0; degree < maxDegree; degree++) {
            ...
            if (
              filteredData.nodes.length <= NODE_COUNT_LIMIT_FOR_AUTO_ENABLING
            ) {
              return degree;
            }
          }
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      module.exports = function () {
        ...
        function isNoFloatingThing(node) {
          ...
          var hasNonFilteredProperties = hasPropertiesOtherThanObjectProperties(
            node,
            properties
          );
      ...
      /* WEBPACK VAR INJECTION */ (function (d3) {
        ...
        module.exports = function () {
          ...
          function hasNoParallelProperties(property) {
            return (
              _.intersection(
                property.domain().links(),
                property.range().links()
              ).length === 1
            );
          }
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      module.exports = function () {
         ...
         * @returns {Array}
         */
        function findRelevantConnectedProperties(
          node,
          allProperties,
          visitedNodes
        ) {
        ...
        function doesNotInheritFromMultipleClasses(
          subclass,
          connectedProperties
        ) {
